...
function NewReleases() {
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      setCurrentGame((prevGame) => (prevGame + 1) % 6);
    }, 9000);
  ...
  const gamesContent: GameContent[] = [
    ...
    },
    {
      ...
      logo: logo[4],
      description:
        "Conquer the streets, to reach The ultimate racing challenge.",
    ...
    },
    {
      ...
      logo: logo[5],
      description:
        "encounter new adventures in the post-apocalyptic world of Horizon",
