...
function NeeForSpeed() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('NFSImg', '/images/gamesImg/NeedForSpeed');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('NFSThumb', '/images/gamesImg/NeedForSpeed/imageThumbnail');
