...
function WuKong() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('WuKongImg', '/images/gamesImg/WuKong');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('WuKongThumb', '/images/gamesImg/WuKong/imageThumbnail');
