...
function DyingLight2() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('DyingLightImg', '/images/gamesImg/DyingLight2');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('DyingLightThumb', '/images/gamesImg/DyingLight2/imageThumbnail');
...
const DyingLight2Memo = memo(DyingLight2)

export default DyingLight2Memo