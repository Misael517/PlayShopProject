                ...
                <section className={styles.section1}>
                    ...
                    <div className={styles.buyingSection}>
                        ...
                        <div className={styles.gamesInfo}>
                            ...
                            <div className={styles.gamesPrice}>
                                <p><span className={jsonData[11].isOnSale ? styles.discountColor : ''}>{jsonData[11].isOnSale ? `-${jsonData[11].discount}%` : ''}</span></p>
                                <p><span className={jsonData[11].isOnSale ? styles.strikeThrough : ''}>{jsonData[11].isOnSale ? `${jsonData[11].price}%` : ''}</span></p>
                                <p style={{ textAlign: 'center' }}>{jsonData[11].isOnSale ? `$${jsonData[11].actualPrice}` : (jsonData[11].coomingSoon ? '...' : `$${jsonData[11].price}`)}</p>
                            </div>
                        </div>
                        <button className={styles.addBtn} onClick={() => dispatch(addItem(jsonData[11]))}>Add to cart</button>
                    </div>
                    ...
                    <div className={styles.detailsContainer}>
                        <div>
                            ...
                            <p className={styles.detailsContent}>{jsonData[11].Platforms}</p>
                        </div>

                        <div>
                            <h3 className={styles.detailsTitle}>Publisher</h3>
                            <p className={styles.detailsContent}>{jsonData[11].Publisher}</p>
                        </div>

                        <div>
                            <h3 className={styles.detailsTitle}>Video Game Genre</h3>
                            <p className={styles.detailsContent}>{jsonData[11].Genre}</p>
                        </div>
                    </div>
                </section>
            </main>
