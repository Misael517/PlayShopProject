...
// Img imports
import img1 from '/images/gamesImg/GodOfWar/img1.jpg';
import img2 from '/images/gamesImg/GodOfWar/img2.jpg';
import img3 from '/images/gamesImg/GodOfWar/img3.jpg';
import img4 from '/images/gamesImg/GodOfWar/img4.jpg';
import img5 from '/images/gamesImg/GodOfWar/img5.jpg';
import img6 from '/images/gamesImg/GodOfWar/img6.jpg';
import img7 from '/images/gamesImg/GodOfWar/img7.jpg';

// thumbnails imports
import thumb1 from "/images/gamesImg/GodOfWar/imageThumbnail/thumb1.jpg";
import thumb2 from "/images/gamesImg/GodOfWar/imageThumbnail/thumb2.jpg";
import thumb3 from "/images/gamesImg/GodOfWar/imageThumbnail/thumb3.jpg";
import thumb4 from "/images/gamesImg/GodOfWar/imageThumbnail/thumb4.jpg";
import thumb5 from "/images/gamesImg/GodOfWar/imageThumbnail/thumb5.jpg";
import thumb6 from "/images/gamesImg/GodOfWar/imageThumbnail/thumb6.jpg";
            ...
            <main className={styles.main}>
                ...
                <section className={styles.section1}>
                    ...
                    <div className={styles.buyingSection}>
                        ...
                        <button className={styles.addBtn} onClick={() => dispatch(addItem(jsonData[13]))}>Add to cart</button>
                    </div>
                    ...
                    <div className={styles.detailsContainer}>
                        <div>
                            ...
                            <p className={styles.detailsContent}>{jsonData[13].Platforms}</p>
                        </div>

                        <div>
                            <h3 className={styles.detailsTitle}>Publisher</h3>
                            <p className={styles.detailsContent}>{jsonData[13].Publisher}</p>
                        </div>

                        <div>
                            <h3 className={styles.detailsTitle}>Video Game Genre</h3>
                            <p className={styles.detailsContent}>{jsonData[13].Genre}</p>
                        </div>
                    </div>
                </section>
            </main>
