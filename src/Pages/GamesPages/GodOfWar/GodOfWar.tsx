...
function GodOfWar() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('GodOfWarImg', '/images/gamesImg/GodOfWar/', 'img', '.jpg', 7);
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('GodOfWarThumb', '/images/gamesImg/GodOfWar/imageThumbnail/', 'thumb', '.jpg', 6);
