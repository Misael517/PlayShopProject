...
function EldenRing() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('EldenImg', '/images/gamesImg/EldenRing');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('EldenThumb', '/images/gamesImg/EldenRing/imageThumbnail');
