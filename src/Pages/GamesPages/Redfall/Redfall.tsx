...
function Redfall() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('RedfallImg', '/images/gamesImg/Redfall');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('RedfallThumb', '/images/gamesImg/Redfall/imageThumbnail');
