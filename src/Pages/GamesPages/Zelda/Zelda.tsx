...
function Zelda() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('ZeldaImg', '/images/gamesImg/Zelda');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('ZeldaThumb', '/images/gamesImg/Zelda/imageThumbnail');
