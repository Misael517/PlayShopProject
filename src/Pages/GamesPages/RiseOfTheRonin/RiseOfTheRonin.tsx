...
function RiseOfTheRonin() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('RiseOfTheRoninImg', '/images/gamesImg/RiseOfTheRonin');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('RiseOfTheRoninThumb', '/images/gamesImg/RiseOfTheRonin/imageThumbnail');
