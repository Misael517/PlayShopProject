...
function DeadSpace() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('DeadSpaceImg', '/images/gamesImg/DeadSpace');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('DeadSpaceThumb', '/images/gamesImg/DeadSpace/imageThumbnail');
