...
function Kena() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('KenaImg', '/images/gamesImg/Kena');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('KenaThumb', '/images/gamesImg/Kena/imageThumbnail');
