...
function Gta5() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('GtaImg', '/images/gamesImg/Gta5');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('GtaThumb', '/images/gamesImg/Gta5/imageThumbnail');
