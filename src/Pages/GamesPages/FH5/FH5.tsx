...
function Fh5() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('Fh5Img', '/images/gamesImg/Fh5');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('Fh5Thumb', '/images/gamesImg/Fh5/imageThumbnail');
