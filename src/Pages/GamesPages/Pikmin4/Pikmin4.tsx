...
function Pikmin4() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('Pikmin4Img', '/images/gamesImg/Pikmin4');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('Pikmin4Thumb', '/images/gamesImg/Pikmin4/imageThumbnail');
