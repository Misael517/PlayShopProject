...
function SuicideSquad() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('SuicideSquadImg', '/images/gamesImg/SuicideSquad');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('SuicideSquadThumb', '/images/gamesImg/SuicideSquad/imageThumbnail');
