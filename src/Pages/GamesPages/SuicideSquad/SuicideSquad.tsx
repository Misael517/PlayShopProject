...
function SuicideSquad() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('SuicideSquadImg', '/images/gamesImg/SuicideSquad/', 'img', '.webp', 7);
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('SuicideSquadThumb', '/images/gamesImg/SuicideSquad/imageThumbnail/', 'thumb', '.webp', 6);
