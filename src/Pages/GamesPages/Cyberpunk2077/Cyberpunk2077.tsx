...
function Cyberpunk2077() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('CyberpukImg', '/images/gamesImg/Cyberpunk2077');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('CyberpunkThumb', '/images/gamesImg/Cyberpunk2077/imageThumbnail');
