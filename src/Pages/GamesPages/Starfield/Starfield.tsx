...
function Starfield() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('StarfieldImg', '/images/gamesImg/Starfield');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('StarfieldThumb', '/images/gamesImg/Starfield/imageThumbnail');
