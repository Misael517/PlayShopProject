...
function ForzaMotosport() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('ForzaMImg', '/images/gamesImg/ForzaMotosport');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('ForzaMThumb', '/images/gamesImg/ForzaMotosport/imageThumbnail');
