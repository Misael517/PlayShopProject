...
function AtomicHeart() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('AtomicHeartImg', '/images/gamesImg/AtomicHeart/', 'img', '.webp', 7);
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('AtomicHeartThumb', '/images/gamesImg/AtomicHeart/imageThumbnail/', 'thumb', '.webp', 6);
