...
function AtomicHeart() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('AtomicHeartImg', '/images/gamesImg/AtomicHeart');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('AtomicHeartThumb', '/images/gamesImg/AtomicHeart/imageThumbnail');
