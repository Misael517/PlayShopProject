...
function Destiny2() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('Destiny2Img', '/images/gamesImg/Destiny2');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('Destiny2Thumb', '/images/gamesImg/Destiny2/imageThumbnail');
