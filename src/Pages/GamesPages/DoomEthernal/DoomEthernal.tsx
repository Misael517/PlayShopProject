...
function DoomEthernal() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('DoomImg', '/images/gamesImg/DoomEthernal');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('DoomThumb', '/images/gamesImg/DoomEthernal/imageThumbnail');
