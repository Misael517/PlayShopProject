...
function BloodLines2() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('BloodLinesImg', '/images/gamesImg/BloodLines2');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('BloodLinesThumb', '/images/gamesImg/BloodLines2/imageThumbnail');
