                ...
                <section className={styles.section1}>
                    ...
                    <div className={styles.buyingSection}>
                        ...
                        <div className={styles.gamesInfo}>
                            ...
                            <div className={styles.gamesPrice}>
                                <p><span className={jsonData[5].isOnSale ? styles.discountColor : ''}>{jsonData[5].isOnSale ? `-${jsonData[5].discount}%` : ''}</span></p>
                                <p><span className={jsonData[5].isOnSale ? styles.strikeThrough : ''}>{jsonData[5].isOnSale ? `${jsonData[5].price}%` : ''}</span></p>
                                <p style={{ textAlign: 'center' }}>{jsonData[5].isOnSale ? `$${jsonData[5].actualPrice}` : (jsonData[5].coomingSoon ? '...' : `$${jsonData[5].price}`)}</p>
                            </div>
                        </div>
                        <button className={styles.addBtn} onClick={() => dispatch(addItem(jsonData[5]))}>Add to cart</button>
                    </div>
                    ...
                    <div className={styles.detailsContainer}>
                        <div>
                            ...
                            <p className={styles.detailsContent}>{jsonData[5].Platforms}</p>
                        </div>

                        <div>
                            <h3 className={styles.detailsTitle}>Publisher</h3>
                            <p className={styles.detailsContent}>{jsonData[5].Publisher}</p>
                        </div>

                        <div>
                            <h3 className={styles.detailsTitle}>Video Game Genre</h3>
                            <p className={styles.detailsContent}>{jsonData[5].Genre}</p>
                        </div>
                    </div>
                </section>
            </main>
...
export default TheCalistoProtocol