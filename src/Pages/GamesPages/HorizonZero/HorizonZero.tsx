...
function HorizonZero() {
    ...
    const { data: img, isLoading: isImagesLoading, isError: isImagesError } = useGetImages('HorizonZeroImg', '/images/gamesImg/HorizonZero');
    const { data: thumb, isLoading: isThumbLoading, isError: isThumbError } = useGetImages('HorizonZeroThumb', '/images/gamesImg/HorizonZero/imageThumbnail');
